...
DATASET_DICT[name] = {'path': '/s1/shared/dataset/pdebench/2D/CFD/2D_Train_Rand/2D_CFD_Rand_M1.0_Eta0.1_Zeta0.1_periodic_128_Train.hdf5'}
...
# DATASET_DICT[name] = {'train_path': './data/large/ns2d_pdb_M1_eta1e-2_zeta1e-2_train.hdf5', 'test_path': './data/large/ns2d_pdb_M1_eta1e-2_zeta1e-2_test.hdf5'}
DATASET_DICT[name] = {'path': '/s1/shared/dataset/pdebench/2D/CFD/2D_Train_Rand/2D_CFD_Rand_M1.0_Eta0.01_Zeta0.01_periodic_128_Train.hdf5'}
# DATASET_DICT[name] = {'train_path': '/datasets/opb/pretrain/ns2d_pdb_M1_eta1e-2_zeta1e-2/train', 'test_path': '/datasets/opb/pretrain/ns2d_pdb_M1_eta1e-2_zeta1e-2/test'}
train_indices, valid_indices, test_indices = split_indices(8000,1000,1000)
DATASET_DICT[name]['train_size'] = 8000
DATASET_DICT[name]['valid_size'] = 1000       ### default 200, maximum 1000
...
DATASET_DICT[name] = {'path': '/s1/shared/dataset/pdebench/2D/CFD/2D_Train_Rand/2D_CFD_Rand_M0.1_Eta0.1_Zeta0.1_periodic_128_Train.hdf5'}
train_indices, valid_indices, test_indices = split_indices(8000,1000,1000)
DATASET_DICT[name]['train_size'] = 8000
DATASET_DICT[name]['valid_size'] = 1000       ### default 200, maximum 1000
DATASET_DICT[name]['test_size'] = 1000
...
DATASET_DICT[name] = {'path': '/s1/shared/dataset/pdebench/2D/CFD/2D_Train_Rand/2D_CFD_Rand_M0.1_Eta0.01_Zeta0.01_periodic_128_Train.hdf5'}
train_indices, valid_indices, test_indices = split_indices(8000,1000,1000)
DATASET_DICT[name]['train_size'] = 8000
DATASET_DICT[name]['valid_size'] = 1000       ### default 200, maximum 1000
DATASET_DICT[name]['test_size'] = 1000
...
DATASET_DICT[name] = {'path': '/s1/shared/dataset/pdebench/2D/CFD/2D_Train_Turb/2D_CFD_Turb_M0.1_Eta1e-08_Zeta1e-08_periodic_128_Train.hdf5'}
...
DATASET_DICT[name] = {'path': '/s1/shared/dataset/pdebench/2D/CFD/2D_Train_Turb/2D_CFD_Turb_M1.0_Eta1e-08_Zeta1e-08_periodic_128_Train.hdf5'}
train_indices, valid_indices, test_indices = split_indices(800,100,100)
DATASET_DICT[name]['train_size'] = 800
DATASET_DICT[name]['valid_size'] = 100      ### default 200, maximum 1000
...
DATASET_DICT[name] = {'path': '/s1/shared/dataset/pdebench/2D/CFD/2D_Train_Rand/2D_CFD_Rand_M0.1_Eta1e-08_Zeta1e-08_periodic_128_Train.hdf5'}
train_indices, valid_indices, test_indices = split_indices(800,100,100)
DATASET_DICT[name]['train_size'] = 800
DATASET_DICT[name]['valid_size'] = 100      ### default 200, maximum 1000
DATASET_DICT[name]['test_size'] = 100      ### default 200, maximum 1000
...
DATASET_DICT[name] = {'path': '/s1/shared/dataset/pdebench/2D/CFD/2D_Train_Rand/2D_CFD_Rand_M1.0_Eta1e-08_Zeta1e-08_periodic_128_Train.hdf5'}
train_indices, valid_indices, test_indices = split_indices(800,100,100)
DATASET_DICT[name]['train_size'] = 800
DATASET_DICT[name]['valid_size'] = 100      ### default 200, maximum 1000
DATASET_DICT[name]['test_size'] = 100      ### default 200, maximum 1000
...
name = 'ns2d_pdb_incom'
DATASET_DICT[name] = {'path': '/s1/shared/dataset/pdebench/2D/NS_incom'}
...
name = 'swe_pdb'
DATASET_DICT[name] = {'path': '/s1/shared/dataset/pdebench/2D/shallow-water/2D_rdb_NA_NA.h5'}
train_indices, valid_indices, test_indices = split_indices(800,100,100)
DATASET_DICT[name]['train_size'] = 800
DATASET_DICT[name]['valid_size'] = 100       ### default 200, maximum 1000
DATASET_DICT[name]['test_size'] = 100
...
#
name = 'ns2d_cond_pda'
DATASET_DICT[name] = {'path': '/home/shared/dataset/pdearena/NavierStokes-2D-conditoned/'}
